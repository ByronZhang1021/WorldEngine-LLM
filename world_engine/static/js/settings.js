...
async function loadSettings() {
    ...
    html += `<div class="form-group"><label class="form-label">Rerank 模型</label><input class="form-input" type="text" value="${escHtml(mrCfg.rerank_model || 'Qwen/Qwen3-Reranker-8B')}" id="settMrRerank"></div>`;
