...
from .memory import load_all_entries, execute_memory_ops, load_emb_cache, save_emb_cache, inject_embeddings
...
def search_relevant_memories(character: str, query: str, top_n: int = 5) -> list[dict]:
    ...
    if needs:
        try:
            ...
            log("warning", f"批量 embedding 失败: {e}")
